...
export default function Projects() {
  return (
    ...
    <section className="my-section">
        ...
        <a href="https://memory-client-xhdb.onrender.com/" target='_blank'  rel="noreferrer">Mern Stack Memory-Card-App</a> <br /> <br />
        <a href="https://mern-frontend-kxrn.onrender.com" target='_blank'  rel="noreferrer">Mern Stack Check-In-App</a> <br /> <br />
